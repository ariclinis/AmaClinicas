...
$pdf->Ln(13);
$pdf->Cell('280','8',utf8_decode('LISTAGEM DAS CONSULTAS MARCADAS'),'','','C');
$pdf->Ln(8);

$pdf->SetFont('Times','B','11');
$pdf->Cell('280','8',utf8_decode('Filtros utilizados'),'','','L');
$pdf->Ln(8);
...
$pdf->Cell(33, $altura, 'Tipo de Consulta', 1, 0, 'L',TRUE);
$pdf->Cell($largura, $altura, utf8_decode('Data Consulta'), 1, 0, 'L',TRUE);
$pdf->Cell(17, $altura, 'Hora', 1, 0, 'L',TRUE);
$pdf->Cell(50, $altura, utf8_decode('Nome do Doctor'), 1, 0, 'L',TRUE);
$pdf->Cell(26, $altura, utf8_decode('Situação'), 1, 0, 'L',TRUE);
...
$cont2++;
     $pdf->Cell(10, $altura, $cont2, 1, 0, 'L');
	$pdf->Cell(60, $altura, utf8_decode($Linha['Nome_Paciente']), 1, 0, 'L');
        $pdf->Cell(21, $altura, $Linha['genero'], 1, 0, 'L');
        $pdf->Cell(33, $altura, utf8_decode($Linha['Tipo_Consulta']), 1, 0, 'L');
	$pdf->Cell($largura, $altura, utf8_decode($Linha['Data_Consult']), 1, 0, 'L');
        $pdf->Cell(17, $altura, $Linha['Hora_Inicio'], 1, 0, 'L');
	$pdf->Cell(50, $altura, utf8_decode($Linha['Nome_Login']), 1, 0, 'L');
	$pdf->Cell(26, $altura, utf8_decode($Linha['Situa']), 1, 0, 'L');
...
$pdf->Footer();
$pdf->cell('278','5',utf8_decode("Documento Processado pelo Computador!                                                                                            Software AmaClinicas V1.00 - www.amatechs.org                        Data.:".date('Y-m-d')."  ||  ".date('H:m')),'','','C',TRUE);
// exibindo o PDF
$pdf->Output();?>