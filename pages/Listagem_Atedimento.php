                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listagem dos Pacientes Atendidos
                        </div>
                        <!-- /.panel-heading -->
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <a type="button" target="_blank" class="btn btn-primary btn-sm" href="../Reports/GestaoConsultasMedicas/Listagem_Atedimento.php"><i class="fa fa-print"></i>  Imprimir Lista</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                       ...
                       <div class="help-block ">
                        ...
                        <div class="panel-footer">
                             <a type="button" class="btn btn-primary btn-sm" target="_blank" href="../Reports/GestaoPacientes/paciente.php"><i class="fa fa-print"></i>  Imprimir Lista</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
