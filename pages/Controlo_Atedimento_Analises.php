                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Controlo de Atedimento de Analises
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-phone">Data Registo</th>
...
$pdo = Ligar::chamar_bd();
     ...
     if(isset($_GET['Presente'])){
        ...
        $Mudar_Estado= $pdo->prepare("UPDATE tbl_marcar_analise SET Estado_Fila ='Aguarda Atedimento',Estado_Consulta='Agendada' WHERE id='$cod_consulta'");
