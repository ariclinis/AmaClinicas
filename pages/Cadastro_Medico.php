...
<body>
    ...
    <div id="wrapper">
	   ...
	   <?php include './Cabecalho.php'; ?>
        ...
        <div id="page-wrapper"><br>
            ...
            <div class="row">
                <div class="col-lg-12">
                <div id="msg_medico"></div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Cadastro de Médico(a)/Enfermeiro(a)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                ...
                                <option value="Angolana">Angolano</option>
                                ...
                                <textarea class="form-control" rows="3" name="obsserva" id="obsserva"></textarea>
                                </div>
                                </div>
                ...
                <button type="button" class="btn btn-success" name="cadastrar_medico"  id="cadastrar_medico" > Cadastrar</button> <button type="button" class="btn btn-danger"><i class="icon-ok"></i>   </i>Cancelar    </i></button>
                    <!-- /.panel -->
                </div>
    ...
    <script type="text/javascript" src="../js/Admin/medicos.js"></script>
