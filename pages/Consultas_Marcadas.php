                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                             <a type="button" target="_blank" class="btn btn-primary btn-sm" href="../Reports/GestaoConsultasMedicas/Listagem_Consultas_Marcadas.php"><i class="fa fa-print"></i>  Imprimir Lista</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                       ...
                       <div class="help-block ">
                        ...
                        <div class="panel-footer">
                            <a type="button" class="btn btn-primary btn-sm" target="_blank" href="../Reports/GestaoConsultasMedicas/Listagem_Consultas_Marcadas.php"><i class="fa fa-print"></i>  Imprimir Lista</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
