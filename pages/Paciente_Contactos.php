                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listagem dos Pacientes Com os Contactos
                        </div>
                        <!-- /.panel-heading -->
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <a type="button" target="_blank" class="btn btn-primary btn-sm" href="../Reports/GestaoPacientes/listagem_contactos.php"><i class="fa fa-print"></i>  Imprimir Lista</a>
                        </div>
                    </div>
                </div>
            </div>
